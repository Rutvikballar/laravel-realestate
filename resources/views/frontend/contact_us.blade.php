...
@php
   ...
   @endphp
        ...
        <section class="contact-info-section sec-pad centred"style="background-image: url({{ asset('frontend/assets/images/banner/img-1.jpg') }});">
            <div class="auto-container">
                <div class="sec-title">
                    <h5>Contact us</h5>
                    <h2>Get In Touch</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <h4>Phone Number</h4>
                                <p><i class="far fa-phone"></i><a href="tel:+23055873407">+{{ $setting->support_phone }}</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <p class="far fa-map-marker-alt"><>{{ $setting->company_address }}</p>
                            </div>
                        </div>
                    </div>
                </div>
