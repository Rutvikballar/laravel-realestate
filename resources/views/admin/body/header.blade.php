@php
$usermsg = App\Models\PropertyMessage::latest()->limit(5)->get();
@endphp
<nav class="navbar">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
          ...
          <div class="row g-0 p-1">
            ...
            <div class="col-3 text-center">
              <a href="{{ route('admin.property.message') }}" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="mail" class="icon-lg mb-1"></i>
...
<script>
  function switchTheme(themeName) {
    document.getElementById('theme-style').href = `{{ asset('backend/assets/css/${themeName}.css') }}`;
  }
